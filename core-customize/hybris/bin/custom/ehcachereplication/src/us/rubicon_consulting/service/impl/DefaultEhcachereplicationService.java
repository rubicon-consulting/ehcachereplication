...
public class DefaultEhcachereplicationService implements EhcachereplicationService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultEhcachereplicationService.class);
	...
	{
		return DefaultEhcachereplicationService.class.getResourceAsStream("/ehcachereplication/sap-hybris-platform.png");
	}
