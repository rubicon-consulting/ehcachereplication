...
import us.rubicon_consulting.service.impl.DefaultEhcachereplicationService;
 ...
 */
@IntegrationTest
public class DefaultEhcachereplicationServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "ehcachereplicationPlatformLogo";

		// when
		final String logoUrl = ehcachereplicationService.getHybrisLogoUrl(logoCode);
